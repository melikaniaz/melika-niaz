      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="rounded-2xl bg-white/5 border border-white/10 p-6 text-white backdrop-blur-sm"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={copyEmail}
                      className="inline-flex items-center gap-2 text-sm px-3 py-1.5 rounded-full bg-white/10 hover:bg-white/20 transition"
                    >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${info.phone.replace(/\s+/g, "")}`} className="text-lg font-semibold hover:underline">
                    {info.phone}
                  </a>
          ...
          >
            <motion.h3 variants={fadeUp} className="text-2xl font-bold text-white mb-6">
              Send a message
            </motion.h3>
            ...
            <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-black/30 text-white border border-white/10 px-4 py-3 outline-none focus:border-pink-500/70"
                />
              </div>
              <div>
            ...
            <motion.div variants={fadeUp} className="mt-6">
              <button
                type="submit"
                className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-pink-500/90 hover:bg-pink-500 transition text-white font-semibold"
              >
                Send
              </button>
            </motion.div>
